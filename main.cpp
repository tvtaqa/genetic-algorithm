...
//数据块大小
int S[B] ={60 ,355 ,135 ,358 ,223 ,200 ,129 ,151 ,147 ,302 ,
           238 ,368 ,233 ,165 ,228 ,74 ,122 ,170 ,2 ,106 ,
           35 ,58 ,380 ,283 ,304 ,95 ,193 ,204 ,194 ,341 ,
           220 ,125 ,311 ,226 ,98 ,150 ,41 ,227 ,172 ,187
};

//每个资源域中心的VM数量
int R[W] ={71 ,59 ,59 ,54 ,49 ,58 ,63 ,45 ,62 ,59 ,
           78 ,52 ,57 ,66 ,63 ,50 ,58 ,47 ,77 ,64
};

//每个资源域中心的VM的存储容量
int M[W] = {397 ,440 ,409 ,80 ,257 ,349 ,551 ,497 ,556 ,477 ,
            107 ,516 ,428 ,372 ,509 ,559 ,406 ,359 ,253 ,228
};

//每个资源域中心的VM的处理速度
int V[W]={32 ,2 ,8 ,8 ,64 ,96 ,48 ,1 ,40 ,64 ,
          2 ,4 ,4 ,32 ,40 ,4 ,16 ,2 ,1 ,96
};

//每个资源域中心对应的网络带宽
double N[W]={2.780 ,2.780 ,0.800 ,1750.000 ,2.780 ,3.500 ,3.500 ,3.500 ,4.000 ,9.500 ,
             13.600 ,10.000 ,2.800 ,2.800 ,2.880 ,2.880 ,2.880 ,6.800 ,13.600 ,19.000
};

//每个资源域中心的租用单价
double P[W]={0.526 ,1.053 ,0.714 ,1.418 ,2.330 ,2.856 ,4.312 ,8.624 ,14.000 ,18.984 ,
             25.312 ,22.400 ,0.721 ,1.442 ,2.884 ,5.768 ,19.012 ,12.656 ,25.200 ,45.696
};

//每个资源域中心的上行带宽费用
double U[W]={0.720 ,0.500 ,0.800 ,0.800 ,0.590 ,0.720 ,0.800 ,0.800 ,0.800 ,0.500 ,
             0.530 ,0.500 ,0.720 ,0.500 ,0.800 ,0.400 ,0.500 ,0.530 ,0.720 ,0.600
};
